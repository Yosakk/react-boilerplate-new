      ...
      <Stack gap="xl">
        ...
        <div>
          ...
          <Text c="dimmed" size="sm">
            Mantine v7 components integrated with react-hook-form and Tailwind CSS.
          </Text>
        </div>
        ...
        <SimpleGrid cols={{ base: 1, sm: 2, lg: 4 }} spacing="md">
          {[
            { icon: LayoutDashboard, label: "AppShell", desc: "Responsive layout" },
        ...
        <Paper p="md" withBorder>
          <Text size="sm" c="dimmed">
            ...
            <Code>Tailwind CSS v4</Code> + <Code>Redux Toolkit</Code> + <Code>react-hook-form</Code>{" "}
            + <Code>Yup</Code>
          </Text>
        </Paper>
      </Stack>
