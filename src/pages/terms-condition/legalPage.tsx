...
export const tncPageRouteName = "/auth/tnc";
...
const LegalPage: React.FC = () => {
  ...
  const { page, setPage, handleBack, handleAccept } = useLegalPage();
    ...
    <div className="flex flex-col items-center">
      ...
      <div className="w-full flex justify-center mt-5">
        ...
        >
          ...
          <p
            className={
              "font-poppins text-sm md:text-base mt-2 " +
              "leading-relaxed opacity-95 max-w-2xl mx-auto"
            }
          >
      ...
      <div className="w-full mt-4 flex flex-col justify-center items-center">
        ...
        >
          ...
          >
            {t("authRegisterAccount.page5.text5")}
          </button>
        </div>
      </div>
    </div>
