export default {
  ...
  "privacyPolicy": {
    ...
    "desc": {
      ...
      "guidelines_2": "Be tolerant towards other’s perspective; respectfully disagree when opinions do not align.",
      ...
      "prohibit_5": "Organize, participate in, or encourage harassment of others. Disagreements happen and are normal, but continuous, repetitive, or severe negative comments may cross the line into harassment and are not tolerated at SEEDS.",
      "prohibit_6": "Organize, promote, or coordinate servers around hate speech. It’s unacceptable to attack a person or a community based on attributes such as their race, ethnicity, national origin, sex, gender, sexual orientation, religious affiliation, or disabilities.",
      "prohibit_7": "Make threats of violence or threaten to harm others. This includes indirect threats, as well as sharing or threatening to share someone’s private personal information.",
      "prohibit_8": "Sexualize minors in any way. This includes sharing content or links which depict minors in a pornographic, sexually suggestive, or violent manner, and includes illustrated or digitally altered pornography that depicts minors (such as lolicon, station, or cub). We will report illegal content to the relevant authority.",
      "prohibit_9": "Share sexually explicit content of yourselves or other people, or share or promote sharing of intimate imagery (also known as revenge porn) in an attempt to shame or degrade someone.",
      "prohibit_10": "Share content that glorifies or promotes suicide or self-harm, including any encouragement to others to cut themselves, or embrace eating disorders such as anorexia or bulimia.",
      ...
      "prohibit_13": "Evade user blocks or server bans. - send unwanted, repeated friend requests or messages, especially after they’ve made it clear they don’t want to talk to you anymore. - try to hide your identity in an attempt to contact someone who has blocked you, or otherwise circumvent the tools we have which enable users to protect themselves.",
      "prohibit_14": "Deceive and impersonate: - misrepresent yourself by using the SEEDS logo or any brands within your avatar and posts.",
      "prohibit_15": "Solicit: - post, share or display any video content on our platform that includes third- party advertising without our prior consent.",
      "policy_title": "Trading Platform Policy",
      "policy_1": "Never post false information: Never post misleading information about your account and/or your trading skills.",
      "policy_2": "Never post Investment advice: Never offer any direct investment advice, or anything that may be interpreted as investment advice. - call for direct action (such as “invest in”).",
      "policy_3": "Do not engage in Market manipulation: - make false promises or entice others to trade/invest or attempt to create volatile market situations",
      "policy_4": "Do not attempt to manipulate other users: - provide instructions on specific trades or on how to trade.",
      "policy_5": "Do not spread fake news: - share/spread misinformation, unverifiable information and rumors.",
      "policy_6": "Do not engage in spamming: - use collusive and manipulation practices and avoid transferring misinformation in order to distort the financial markets, or posting the same information multiple times on various posts.",
      "consequences": "Consequences",
      "consequences_desc": "We will take action when we see someone violating these guidelines. Sometimes that just means giving someone a warning; other times it means revoking certain privileges or accounts entirely. We request that all community members report behavior that violates our guidelines to info@SEEDS.finance.",
      "agreement": "Agreement",
      "agreement_desc": "By logging onto the community and activating your profile, you are considered to be in agreement with the terms and conditions listed above."
    }
  },
  "circleMembership": {
    "reply": "Reply...",
    "title": "Circle Membership",
    "announcement": "This Terms and Condition (“Terms”) is entered into force as of the date you click the “Accept Terms” button, or other equivalent button, indicating your acceptance of these terms (the “Effective Date”) between PT Benih Investasi Teknologi, a company having its domicile at Apartemen Casablanca unit 17-12 Tower 2 Wing B, Jl. Casablanca Kav.12, Jakarta Selatan 12870 (“SEEDS”), and the entity agreeing to these terms (“Circle Owner”).",
    "lastupdate": "Last Updated: ",
    "updatedate": "26 April 2022",
    "content": {
      "title": {
