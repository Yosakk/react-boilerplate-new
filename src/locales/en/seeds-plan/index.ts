export default {
  ...
  "howToUse": "Open the Seeds Finance app. Select the Quiz, Play Tournament, and Team Battle in the \"Play\" section or select \"Circle\" and \"Premium Post\" in the \"Social\" section according to your choice. On the payment page, select payment method and voucher (including the Seeds Unlimited voucher you purchased). If the voucher is already active, you will be able to participate in variety of premium discount for free, depending on the type of voucher you purchased. Yay! Now you can join and enjoy multiple savings",
  ...
  "text16": "Expired on ",
  "text17": "Want to change or continue your SeedsPlan for the next activation? Pay now, and you won’t have to worry about it later!",
  ...
  "modalChangePlan": {
    ...
    "description": " You can make the switch instantly, and your new plan automatically applied once your current plan expires",
    "button1": "Later",
    "button2": "Next"
  },
  "history": {
