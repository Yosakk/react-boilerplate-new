export default {
  "warning": "Please complete onboarding steps.",
  "leftBanner": {
  ...
  "question": {
    ...
    "answers": {
      ...
      "text4": "Awesome! Let’s use your preferred ways to learn and make this journey even more engaging!"
    }
  },
  "questionDone": {
    "text1": {
      "part1": "Thanks for sharing! You're interested in ",
      "part2": ", and currently you're ",
      "part3": " stage.",
      "part4": " What sparked your interest is ",
      "part5": ", and your preferred way to learn by ",
      "part6": ". That’s a solid combo, let’s build from here and make your learning journey exciting and tailored just for you!"
    },
