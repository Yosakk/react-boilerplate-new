export default {
  ...
  spaceInSeedsTag: "SeedsTag cannot contain spaces, please delete your spaces!",
  requiredName: "Name is required, please enter your name!",
  invalidEmail: "Please enter your email address in format yourname@example.com",
  requiredEmail: "Email is required, please enter your email!",
  invalidPhoneNumber: "Phone number only accept 1-9",
  requiredPhoneNumber: "Phone number is required, please enter your phone number!",
