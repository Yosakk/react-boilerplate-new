export default {
  ...
  "list": {
    "title": "Circle List",
    "description": "Explore our list of communities, find the ones that match with your interest, or create one."
  },
  "banner": {
  ...
  "success": {
    "title": "Success!",
    "subtitle": "Congratulations! The new Circle has been successfully created. Share your Circle Now!"
  },
  "empty": {
    "title": "Sorry",
