export default {
  ...
  "product": {
    "section1": {
      ...
      "subtitle": "Tantang pengetahuan finansialmu dengan permainan menarik dan menangkan uang tunai"
    },
    "section2": {
    ...
    "section5": {
      "title1": "Cara Bermain",
      "title2": "Turnamen",
      "title3": "Yuk, Tonton untuk mempelajari semua tentang turnamen dan trading virtual di sini!"
    },
    "section6": {
      "title1": "Unduh Sekarang!",
      "title2": "Mulai Perjalanan Investasimu!",
      "title3": "Perluas koneksi, belajar finansial dan tingkatkan portfolio kamu bersama Seeds."
    }
  }
} as const;
