export default {
  ...
  "section2": {
    "text1": "Social",
    "text2": "Berdiskusi dan berkoneksi dengan berbagai ahli keuangan untuk memulai perjalanan finansial yang sukses."
  },
  "section3": {
  ...
  "section11": {
    ...
    "text2": "Buat investasi jadi  menyenangkan, untuk masa depan. Bergabunglah dengan perkembangan Seeds sekarang!",
    "text3": "Bergabunglah dengan kami, ikut terlibat, dan bersama-sama mari kita bentuk masa depan investasi!",
    "text4": "Hubungi Kami"
  },
  "section12": {
