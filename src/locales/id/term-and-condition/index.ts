export default {
  ...
  privacyPolicy: {
    ...
    desc: {
      header: "KEBIJAKAN PENGGUNA",
      p1: "SEEDS dibangun dengan dasar semangat berkomunitas, bertemu satu sama lain, berbicara tentang investasi, berbagi ide, dan berinvestasi bersama. Pedoman sosial & komunitas kami dimaksudkan untuk menjelaskan apa yang boleh dan tidak diizinkan di SEEDS, dan memastikan bahwa setiap orang memiliki pengalaman yang baik. Jika Anda menemukan pesan yang tampaknya melanggar aturan ini, harap laporkan kepada kami. Kami dapat mengambil sejumlah langkah, termasuk mengeluarkan peringatan, menghapus konten, atau menghapus akun dan/atau server yang bertanggung jawab.",
      p2: "Untuk memenuhi tujuan komunitas ini, penting bagi anggota untuk merasa seperti mereka berada di tempat yang aman yang dihuni oleh orang-orang dengan minat yang sama. Karena itu, kami meminta Anda untuk membaca dan mematuhi pedoman berikut",
      guidelines_title: "Pedoman",
      guidelines_1:
        "Perlakukan orang lain secara online seperti Anda memperlakukan mereka di kehidupan nyata.",
      guidelines_2:
        "Bersikap toleran terhadap sudut pandang orang lain; dengan hormat tidak setuju ketika pendapat tidak sejalan.",
      guidelines_3: "Hormati privasi dan informasi pribadi Pengguna lainnya.",
      guidelines_4: "Berkomunikasi dengan sopan dan hormat",
      prohibit_title: "Pengguna dilarang keras untuk",
      prohibit_1: "Melakukan serangan pribadi terhadap Pengguna lainnya.",
      prohibit_2:
        "Menggunakan komentar yang memfitnah atau membuat pernyataan palsu terhadap orang lain.",
      prohibit_3: "Posting komentar berprasangka atau tidak senonoh.",
      prohibit_4:
        "Mengganggu atau membuat komentar yang menghasut kepada anggota komunitas lainnya.",
      prohibit_5:
        "Mengatur, berpartisipasi dalam, atau mendorong pelecehan terhadap orang lain. Ketidaksepakatan terjadi dan normal, tetapi komentar negatif yang terus menerus, berulang, atau parah dapat melewati batas menjadi pelecehan dan tidak ditoleransi di SEEDS.",
      prohibit_6:
        "Mengatur, mempromosikan, atau mengoordinasikan server seputar ujaran kebencian. Menyerang seseorang atau komunitas berdasarkan atribut seperti ras, etnis, asal negara, jenis kelamin, jenis kelamin, orientasi seksual, afiliasi agama, atau disabilitas mereka tidak dapat diterima",
      prohibit_7:
        "Membuat ancaman kekerasan atau mengancam untuk menyakiti orang lain. Ini termasuk ancaman tidak langsung, serta berbagi atau mengancam untuk membagikan informasi pribadi pribadi seseorang.",
      prohibit_8:
        "Melakukan seksualisasi anak di bawah umur dengan cara apapun. Ini termasuk berbagi konten atau tautan yang menggambarkan anak di bawah umur dengan cara pornografi, menjurus ke arah seksual, atau kekerasan, dan termasuk pornografi bergambar atau diubah secara digital yang menggambarkan anak di bawah umur (seperti lolicon, shotacon, atau cub). Kami akan melaporkan konten ilegal ke otoritas terkait.",
      prohibit_9:
      ...
      prohibit_13:
        "Menghindari blok pengguna atau larangan server. - mengirim permintaan atau pesan pertemanan yang berulang dan tidak diinginkan, terutama setelah mereka menjelaskan bahwa mereka tidak ingin berbicara dengan Anda lagi. - mencoba menyembunyikan identitas Anda dalam upaya untuk menghubungi seseorang yang telah memblokir Anda, atau menghindari alat yang kami miliki yang memungkinkan pengguna untuk melindungi diri mereka sendiri.",
      prohibit_14:
        "Menipu dan menyamar: - salah menggambarkan diri Anda dengan menggunakan logo SEEDS atau merek apa pun dalam avatar dan postingan Anda.",
      prohibit_15:
        "Meminta: - memposting, membagikan, atau menampilkan konten video apa pun di platform kami yang menyertakan iklan pihak ketiga tanpa persetujuan kami sebelumnya.",
      policy_title: "Ketentuan Platform Perdagangan",
      policy_1:
        "Jangan pernah memposting informasi palsu: Jangan pernah memposting informasi yang menyesatkan tentang akun Anda dan/atau keterampilan trading Anda.",
      policy_2:
        'Jangan pernah memposting saran Investasi: Jangan pernah menawarkan saran investasi langsung, atau apa pun yang dapat ditafsirkan sebagai saran investasi. - menyerukan tindakan langsung (seperti "berinvestasi").',
      policy_3:
        "Jangan terlibat dalam manipulasi Pasar: - membuat janji palsu atau membujuk orang lain untuk berdagang/berinvestasi atau berusaha menciptakan situasi pasar yang bergejolak.",
      policy_4:
        "Jangan mencoba memanipulasi pengguna lain: - berikan instruksi tentang perdagangan tertentu atau tentang cara berdagang.",
      policy_5:
        "Jangan menyebarkan berita palsu: - membagikan/menyebarkan informasi yang salah, informasi yang tidak dapat diverifikasi, dan rumor.",
      policy_6:
        "Jangan terlibat dalam spamming: - gunakan praktik kolusi dan manipulasi dan hindari mentransfer informasi yang salah untuk mendistorsi pasar keuangan, atau memposting informasi yang sama beberapa kali di berbagai postingan.",
      consequences: "Konsekuensi",
      consequences_desc:
        "Kami akan mengambil tindakan ketika kami melihat seseorang melanggar pedoman ini. Terkadang itu hanya berarti memberi seseorang peringatan; di lain waktu itu berarti mencabut hak istimewa atau akun tertentu seluruhnya. Kami meminta semua anggota komunitas melaporkan perilaku yang melanggar pedoman kami ke info@SEEDS.finance.",
      agreement: "Persetujuan",
      agreement_desc:
        "Dengan masuk ke komunitas dan mengaktifkan profil Anda, Anda dianggap setuju dengan syarat dan ketentuan yang tercantum di atas.",
    },
  },
  circleMembership: {
    reply: "Balas...",
