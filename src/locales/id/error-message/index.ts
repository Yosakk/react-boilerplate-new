export default {
  ...
  "spaceInSeedsTag": "Seeds Tag tidak boleh mengandung spasi, mohon hapus spasi Anda!",
  ...
  "requiredPhoneNumber": "Nomor telepon dibutuhkan, mohon masukan nomor telepon Anda!",
