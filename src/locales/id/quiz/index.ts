export default {
  ...
  "freeOptions": "1 Power-Up Gratis! Pilihlah dengan tepat, menggukan lebih banyak akan ada biaya tambahan",
  ...
  "understand": "Mengerti",
  "payAttention": "Perhatikan response Seedy, Kamu tidak bisa melihatnya lagi setelah menekan Mengerti.",
  "beMindful": "Harap perhatikan vote dari Seedy's friends, Kamu tidak bisa melihatnya lagi setelah menekan Mengerti.",
  ...
  "quizInformation": "Kami akan memberikan serangkaian pertanyaan terkait cryptocurrency. Jawab semua pertanyaan dengan benar untuk mendapatkan poin, dan Kamu juga dapat menggunakan bantuan Seedy.",
  "playAgain": "Main Lagi",
  ...
  "quizCategory": {
    "all": "Semua",
    "allDesc": "Selamat datang di Kuis Keuangan & Investasi Umum! Coba pengetahuan keuanganmu dengan pertanyaan seputar investasi sehari-hari kayak Reksa Dana, Saham Amerika, Saham Indonesia, Obligasi Keuangan, Emas, Kripto, Forex, dan investasi P2P. Cara yang seru buat ngetes pengetahuan finansialmu sambil belajar lebih banyak tentang dunia keuangan! Siap buat mencoba?",
    "mutualFunds": "Reksadana",
    "mutualFundsDesc": "Uji pengetahuanmu tentang reksadana dengan kuis ini! Pelajari dasar-dasar investasi reksadana, jenis-jenis reksadana, dan bagaimana mereka dapat membantu kamu mencapai tujuan keuanganmu.",
    "investment": "Investasi",
    "investmentDesc": "Uji pengetahuanmu tentang berinvestasi dan pelajari cara memilih produk terbaik untuk tujuan keuanganmu. Kuis ini mencakup topik seperti risiko, hasil, diversifikasi, evaluasi, dan regulasi.",
    "stock": "Saham",
    "stockDesc": "Seberapa baik Anda mengetahui pasar saham dan investasi? Ikuti kuis ini dan cari tahu! Kuis ini akan membantu Anda meningkatkan literasi keuangan dan keterampilan Anda dalam menganalisis data pasar saham",
    "usStock": "Saham AS",
    "usStockDesc": "Tantang dirimu sendiri dengan pertanyaan tentang sejarah, kinerja, dan regulasi pasar saham AS. Pelajari bagaimana NYSE dan NASDAQ berkembang, bagaimana indeks saham dihitung, dan faktor-faktor apa yang memengaruhi harga saham.",
    "idStock": "Saham ID",
    "idStockDesc": "Uji pengetahuanmu tentang Bursa Efek Indonesia dan perusahaan yang terdaftar di dalamnya. Pelajari bagaimana Indeks Harga Saham Jakarta dihitung, sektor dan industri apa yang mendominasi perekonomian, dan faktor-faktor apa yang memengaruhi harga saham.",
    "financial": "Keuangan",
    "financialDesc": "Uji literasi keuangan kamu dan tingkatkan keterampilan pengelolaan uangmu. Pelajari cara membuat anggaran, menabung, menggunakan kredit, dan merencanakan masa depanmu.",
    "gold": "Logam Mulia",
    "goldDesc": "Uji pengetahuanmu tentang logam-logam mulia paling berharga di Bumi. Pelajari tentang sifat-sifatnya, penggunaan, sejarah, dan sumber-sumbernya.",
    "crypto": "Kripto",
    "cryptoDesc": "Uji pengetahuanmu tentang mata uang kripto, aset digital yang sedang merevolusi dunia keuangan. Pelajari tentang sejarah, teknologi, regulasi, dan trennya.",
    "forex": "Forex",
    "forexDesc": "Pelajari tentang pasar valuta asing, pasar terbesar dan paling likuid di dunia. Kuis ini mencakup topik seperti pasangan mata uang, nilai tukar, strategi perdagangan, bank sentral, dan risiko forex.",
    "p2p": "P2P (Peer-to-Peer)",
    "p2pDesc": "Masuki dunia Peer-to-Peer Lending dengan kuis kami! Jelajahi bagaimana platform P2P bekerja, risiko dan manfaatnya, serta seluk-beluk meminjam dan meminjam langsung dari individu. Uji pengetahuanmu tentang P2P lending dan temukan apakah pendekatan inovatif keuangan ini cocok untukmu.",
    "financialBonds": "Obligasi Keuangan",
    "financialBondsDesc": "Pelajari tentang berbagai jenis obligasi, instrumen utang yang memungkinkan entitas untuk meminjam uang dari investor. Kuis ini mencakup topik seperti karakteristik obligasi, penilaian, risiko, dan strategi."
  },
  "free": "Gratis",
  "lifeline": "Bantuan Tambahan",
  "tryInfo": "Oopss, kesempatan kamu bermain quiz gratis cuma bisa 1 kali aja nih. Cobain quiz menarik lainnya yuk!",
  "day": "{{days}} hari",
  "players": "Pemain",
  "entryFee": "Tiket Kuis",
  "entFee": "Tiket masuk",
