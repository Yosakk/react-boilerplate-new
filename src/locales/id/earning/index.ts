export default {
  ...
  "withdrawalProcessed": "Permintaan penarikan dana kamu sedang diproses. Mohon tunggu maksimal 1x24 jam.",
  ...
  "withdrawKyc": {
    ...
    "text3": "✨ Memverifikasi identitas Anda membantu menjaga keamanan akun dan memastikan transaksi berjalan lancar. Caranya mudah — cukup unggah identitas Anda dan tunggu sebentar untuk persetujuan.",
    ...
    "text32": "Kami tidak dapat memverifikasi identitas Anda. Silakan periksa alasan yang diberikan dan coba lagi dengan mengunggah foto KTP dan selfie yang jelas.",
    "text33": "Verifikasi identitas Anda sedang diproses.",
    "text34": "⏳ Mohon tunggu sebentar — kami sedang meninjau dokumen Anda untuk memastikan keamanan akun dan kelancaran transaksi.",
